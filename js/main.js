/**
 * 蓝鲸配置平台 (BK-CMDB) - 落地页交互脚本
 * BK-CMDB Landing Page JavaScript
 */
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  progressBar.style.cssText = `
    ...
    left: 0;
    height: 3px;
    background: linear-gradient(90deg, #06b6d4, #f7b733);
    z-index: 9999;
  ...
  if (carousel) {
    ...
    function startAutoPlay() {
      autoPlayInterval = setInterval(nextImage, 5000); // Auto-play every 5 seconds
    }
  ...
  console.log('%c蓝鲸CMDB深度定制', 'color: #06b6d4; font-size: 20px; font-weight: bold;');
  console.log('%c精细化用户与权限管理方案', 'color: #64748b; font-size: 12px;');
});
